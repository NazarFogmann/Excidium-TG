...
//	/datum/admins/proc/show_traitor_panel,	/*interface which shows a mob's mind*/ -Removed due to rare practical use. Moved to debug verbs ~Errorage
	...
	/datum/admins/proc/togglelooc,		/*toggles looc on/off for everyone*/ // excidium - LOOC
	/datum/admins/proc/toggleloocdead,	/*toggles looc on/off for everyone who is dead */ // excidium - LOOC
