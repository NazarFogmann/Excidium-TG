...
/datum/admin_help
	var/id
	var/name
	var/name_b //excidium - localisation
...
/datum/admin_help/New(msg, client/C, is_bwoink)
	...
	name = msg
	name_b = pa2pb(msg) //excidium - localisation
...
/datum/admin_help/proc/Retitle()
	...
	new_title = html_encode(new_title) //excidium - localisation
	if(new_title)
		name = new_title
		name_b = pa2pb(new_title) //excidium - localisation
...
/obj/effect/statclick/ahelp/update()
	return ..(ahelp_datum.name_b) //excidium - localisation
